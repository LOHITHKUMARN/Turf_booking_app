class Tournament {
  ...
  factory Tournament.fromJson(Map<String, dynamic> json) {
    try {
      print('DEBUG: Parsing tournament JSON: ${json['_id']}');
      final tournament = Tournament(
        ...
        registrationDeadline: json['registrationDeadline'] != null ? DateTime.parse(json['registrationDeadline']) : DateTime.now(),
      ...
      print('DEBUG: Successfully parsed tournament: ${tournament.id}, isRegistered: ${tournament.isRegistered}');
      return tournament;
    } catch (e, stack) {
      print('DEBUG ERROR in Tournament.fromJson: $e');
  ...
  factory TournamentMatch.fromJson(Map<String, dynamic> json) {
    try {
      final match = TournamentMatch(
        id: json['_id'] ?? '',
        tournamentId: json['tournamentId'] is Map ? json['tournamentId']['_id'] : (json['tournamentId'] ?? ''),
        team1Id: json['team1Id'] is Map ? json['team1Id']['_id'] : (json['team1Id']),
        team2Id: json['team2Id'] is Map ? json['team2Id']['_id'] : (json['team2Id']),
        winnerId: json['winnerId'] is Map ? json['winnerId']['_id'] : (json['winnerId'] ?? ''),
      ...
      print('DEBUG ERROR in TournamentMatch.fromJson: $e');
      print('DEBUG JSON DATA: $json');
      print('DEBUG STACK TRACE: $stack');
      rethrow;
    }
