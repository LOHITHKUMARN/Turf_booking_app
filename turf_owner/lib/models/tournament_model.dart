class Tournament {
  ...
  Tournament copyWith({
    ...
    return Tournament(
      ...
      registeredTeamsCount: registeredTeamsCount ?? this.registeredTeamsCount,
      turf: turf ?? this.turf,
    );
  }
  ...
  factory Tournament.fromJson(Map<String, dynamic> json) {
    return Tournament(
      id: json['_id'] ?? json['id'] ?? '',
      ownerId: json['ownerId'] is Map ? (json['ownerId']['_id'] ?? json['ownerId']['id'] ?? '') : (json['ownerId'] ?? ''),
      turfId: json['turfId'] is Map ? (json['turfId']['_id'] ?? json['turfId']['id'] ?? '') : (json['turfId'] ?? ''),
      name: json['name'] ?? '',
